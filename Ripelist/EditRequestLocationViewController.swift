...
class EditRequestLocationViewController: UIViewController,
                                         MKMapViewDelegate,
...
// MARK: - View Construction
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        Flurry.logEvent("Edit Request Location")
        ...
        let locationGeoPoint = requestObject["location"] as! PFGeoPoint
        ...
        let tapToAddPin = UILongPressGestureRecognizer(target: self, action: #selector(EditRequestLocationViewController.action(_:)))
...
// MARK: - Mapview Delegate Methods
    ...
    @IBAction func saveButton(_ sender: AnyObject) {
        ...
        requestObject["location"] = newGeopoint
        requestObject.saveInBackground { (success: Bool, error: NSError?) -> Void in
            if success {
